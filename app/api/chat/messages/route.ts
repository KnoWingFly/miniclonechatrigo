...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('GET messages - Session found:', !!session, 'Session userId:', session?.userId)
    ...
    if (session.userId !== dbUser.id) {
      console.log('GET messages - User mismatch! Session user:', session.userId, 'Current user:', dbUser.id)
      return NextResponse.json({ messages: [] })
    }
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('POST message - Request:', { chatSessionId, senderId, senderName })
    ...
    console.log('POST message - Session found:', !!session, 'Session userId:', session?.userId)
